        ...
        <div class="price-container mode-bg">
            ...
            <div class="price-table">
                <table class="table">
                    ...
                    <tbody>
                        @foreach($rentalps as $rentps)
                            <tr>
                                <td class='mode-text' scope='row'>{{ $rentps->id }}</td>
                                <td class='mode-text'>{{ $rentps->brand->merek }}</td>
                                <td class='mode-text'>{{ $rentps->jenis }}</td>
                                <td class='mode-text'>Rp.{{ $rentps->harga }}/day</td>
                                <td class='mode-text'><b>Rp.{{ $rentps->per_week }}</b>/week</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
